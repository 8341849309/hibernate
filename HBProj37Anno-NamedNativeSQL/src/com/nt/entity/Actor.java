...
@Entity
@NamedNativeQuery(name = "GET_ALL_ACTORS", query = "SELECT * FROM ACTOR")
@NamedNativeQuery(name = "GET_ACTORS_GREATER_THAN_LIMIT", query = "SELECT * FROM ACTOR WHERE REMUNERATION>:start")
public class Actor {
